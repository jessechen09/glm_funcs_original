...
public class Function4212 {
      public final void getStripeKeyData(final String str) {
        ...
        stripeKey.enqueue(new Callback<ResponseBody>() { // from class: com.app.jeeves.homeScreen.drawerMenu.settings.CreatePinActivity$getStripeKeyData$1
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.code() == 200) {
                    ...
                    CreatePinActivity.this.getEditPinRequestModel().setId(CreatePinActivity.this.getId());
                    EditPinRequestModel editPinRequestModel = CreatePinActivity.this.getEditPinRequestModel();
                    ...
                    CreatePinActivity.Companion.setPinEncrypted(jWEObject.serialize());
                    CreatePinActivity.this.setResult(123, new Intent());
