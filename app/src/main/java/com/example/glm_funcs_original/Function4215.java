            ...
            stripeKey.enqueue(new Callback<ResponseBody>() { // from class: com.app.jeeves.homeScreen.cards.EditPinActivty$getStripeKeyData$1
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    ...
                    if (response.code() == 200) {
                        ...
                        EditPinActivty.this.getEditPinRequestModel().setId(EditPinActivty.this.getId());
                        EditPinRequestModel editPinRequestModel = EditPinActivty.this.getEditPinRequestModel();
                        ...
                        EditPinActivty.this.getEditPinVM().cardPinSetup(EditPinActivty.this.getEditPinRequestModel());
